...
export const highlights: Record<string, HighlightEntry> = {
  ...
  Maqbool61:            { name: 'Maqbool Ahmed',        highlight: 'Fixed /stats overcounting with anchored markers, cost gate for unsupported IDEs in accumulateEvent, chmod 600 hardening on audit.log, aider-watcher reset on file truncation/rotation, and hybrid debounce with extension filtering in codebuddy-adapter', since: 'Jun 29, 2026', prs: 5, badges: ['bugHunter', 'reliability'], additions: 237  },
