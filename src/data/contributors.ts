...
export const highlights: Record<string, HighlightEntry> = {
  ...
  Tyr1onX:              { name: 'Tyr1onX',                highlight: 'Kept the dashboard /ping polling alive while the WebSocket is down, moving the poll to a single self-healing timer chain pinned by a regression test, in his first ever open source contribution', since: 'Jul 20, 2026', prs: 1, commits: 1, badges: ['bugHunter'], additions: 160 },
};
