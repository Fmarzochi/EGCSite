...
export const highlights: Record<string, HighlightEntry> = {
  ...
  Tyr1onX:              { name: 'Tyr1onX',                highlight: 'Three dashboard reliability fixes in his first week in open source: ping polling that survives a dead WebSocket, replay file paths recovered from detail events, and a capped WebSocket reconnect with a real disconnected state, each pinned by a regression test', since: 'Jul 20, 2026', prs: 3, commits: 3, badges: ['bugHunter'], additions: 265 },
};
