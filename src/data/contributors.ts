...
export const highlights: Record<string, HighlightEntry> = {
  ...
  harshjainnn:          { name: 'harshjainnn',           highlight: 'Built the dashboard offline badge with per-endpoint failure streaks, then hardened POST /event to reject malformed JSON with a 400, refactoring the test suite into a reusable server helper unprompted', since: 'Jul 19, 2026', prs: 2, commits: 2, badges: ['newFeature', 'bugHunter'], additions: 224 },
};
