...
export const highlights: Record<string, HighlightEntry> = {
  ...
  Akisolu:              { name: 'Akisolu',                highlight: 'Fixed the zh-CN README rendering after catching that the issue itself pointed at the wrong file, then ran the Windows testing mission whose report exposed that the Quick Start install was broken in every clean environment; came back for the v1.1.17 release with an even more detailed Windows install report, version mismatch, missing install-state, dashboard and cross-tool memory gaps, that traced back to a missing npm link step in the test instructions themselves', since: 'Jul 19, 2026', prs: 1, commits: 1, badges: ['bugHunter', 'crossPlatform'], additions: 1 },
