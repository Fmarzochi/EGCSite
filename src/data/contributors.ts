...
export const highlights: Record<string, HighlightEntry> = {
  ...
  Maqbool61:            { name: 'Maqbool Ahmed',        highlight: 'Fixed /stats overcounting with anchored markers, cost gate for unsupported IDEs in accumulateEvent, chmod 600 hardening on audit.log, and aider-watcher reset on file truncation/rotation', since: 'Jun 29, 2026', prs: 4, badges: ['bugHunter', 'reliability'], additions: 211  },
