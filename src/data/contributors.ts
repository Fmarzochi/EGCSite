...
export const highlights: Record<string, HighlightEntry> = {
  ...
  fuentes71:            { name: 'Matheus Fuentes',        highlight: 'Security audit and reliability sweep: shell-injection fix (spawnSync), atomic SQLite migrations, SEC-05 byte-load limits, Zod schema enforcement, TOCTOU getDb fix, JSON parse crash guard, hook dispatcher, stdin leak, SQLITE_FULL handling, and async trace log — 9 PRs merged', since: 'Jul 3, 2026', prs: 9, badges: ['bugHunter', 'crossPlatform', 'security'], additions: 438 },
};
