...
export const highlights: Record<string, HighlightEntry> = {
  ...
  developmentwithparth1311: { name: 'Parth Kumbhar',      highlight: 'Diagnosed and fixed the dashboard session shim lingering as a zombie process after every session event, with a clean first-run-green PR', since: 'Jul 19, 2026', prs: 1, commits: 1, badges: ['bugHunter'], additions: 18 },
  harshjainnn:          { name: 'harshjainnn',           highlight: 'Built the dashboard offline badge with per-endpoint failure streaks, taking review feedback through two fast, correct revisions including a stuck-badge edge case he caught himself', since: 'Jul 19, 2026', prs: 1, commits: 1, badges: ['newFeature'], additions: 65 },
};
