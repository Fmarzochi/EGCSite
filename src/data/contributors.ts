...
export const highlights: Record<string, HighlightEntry> = {
  ...
  Tyr1onX:              { name: 'Tyr1onX',                highlight: 'Four dashboard reliability fixes in his first days in open source: ping polling that survives a dead WebSocket, replay file paths from detail events, a capped WebSocket reconnect, and a TOCTOU-safe log watcher, each pinned by a regression test', since: 'Jul 20, 2026', prs: 4, commits: 4, badges: ['bugHunter'], additions: 333 },
};
