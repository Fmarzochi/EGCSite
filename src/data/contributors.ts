...
export const highlights: Record<string, HighlightEntry> = {
  ...
  'hanu-14':            { name: 'Mohammed Hanan',         highlight: 'Preserved multi-byte UTF-8 characters split across TCP chunks in the dashboard POST /event handler, buffering the raw bytes before decoding so multibyte payloads survive chunk boundaries', since: 'Jul 21, 2026', prs: 1, commits: 1, badges: ['bugHunter'], additions: 52 },
};
